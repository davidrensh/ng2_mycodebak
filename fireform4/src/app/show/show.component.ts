...
export class ShowComponent implements AfterViewInit, OnChanges, OnDestroy, OnInit {
  ...
  <div *ngIf="validPassword()">
    ...
    <button *ngIf="!staticneedsignature() || (staticneedsignature() && signed )"
     class="btn btn-primary-outline btn-sm" (click)="saveData()">Save Data</button>
    <div  id="print-section"><div class="printborder">` + t + `</div></div>
  </div>`;
    return s;
  }
  public refreshContent() {
    ...
    //console.log('aa' + JSON.stringify( this.dstable) + JSON.stringify(this.attrdata));
    this.tb.createComponentFactory(template, this.dstable, this.attrdata, ShowComponent.namelist, this.selectedName)
      .then((factory: ComponentFactory<IHaveDynamicData>) => {
        //console.log('aa00' + JSON.stringify(this.dynamicComponentTarget));
